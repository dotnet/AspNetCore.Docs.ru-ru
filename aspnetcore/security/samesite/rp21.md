...
---
# <a name="aspnet-core-21-razor-pages-samesite-cookie-sample"></a>Пример ASP.NET Core 2,1 Razor страниц SameSite cookie

Этот образец предназначен для целевого платформа .NET Framework
