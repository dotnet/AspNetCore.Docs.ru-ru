...
## <a name="implicit-razor-expressions"></a>Неявные Razor выражения
...
## <a name="explicit-razor-expressions"></a>Явные Razor выражения
...
## <a name="razor-code-blocks"></a>Razor блоки кода
...
Директива `@typeparam` объявляет параметр универсального типа для созданного класса компонента. Для получения дополнительной информации см. <xref:blazor/components/templated-components>.

::: moniker-end

## <a name="templated-razor-delegates"></a>Шаблонные Razor делегаты
...
### <a name="razor-keywords"></a>Razor словами
...
### <a name="c-razor-keywords"></a>RazorКлючевые слова C#
...
### <a name="reserved-keywords-not-used-by-razor"></a>Зарезервированные ключевые слова не используются Razor

* `class`

## <a name="inspect-the-razor-c-class-generated-for-a-view"></a>Проверка Razor класса C#, созданного для представления
